...
These principal crates account for 2,556 of the 3,211 passing tests. The
remaining 655 are `tron-node` (411), `tron-types` (74), the four vendored
...
```sh
cargo test --workspace            # 3211 tests, all defaults

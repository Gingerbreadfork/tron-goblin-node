...
| `tron-actuator`  | 437 | `tron-net`       |  78 |
| `tron-rpc`       | 421 | `tron-index`     | 127 |
| `tron-tvm`       | 690 | `tron-crypto`    |  40 |
...
These crates account for 3,142 of the 3,312 passing tests. The remaining
...
```sh
cargo test --workspace            # 3312 tests, all defaults
